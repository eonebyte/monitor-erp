// plugins/sales.mjs
export default async function salesInvoicePlugin(fastify, options) {
  // Route for sales invoices
  fastify.get('/api/sales/invoice', async (request, reply) => {
      ...
      try {
          ...
          reply.status(500).send({ error: 'Failed to fetch sales invoices' });
      } finally {
